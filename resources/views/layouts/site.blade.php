...
<body{{ (isset($classes))?' class='.$classes:'' }}>
	...
	<div class="header">
		<div class="container-fluid">
		    <div class="row">
		        <div class="col col-sm-3 col-xs-3 menu-button">
		        </div>
		        <div class="col col-sm-6 col-xs-9 rtecenter"> 
				    <div class='site-logo'>
				        <a href='/' title='{{ config('app.name', 'Laravel') }}' rel='home'><img class="img-responsive" src='/registration/images/logo.png' alt='{{ config('app.name', 'Laravel') }}'></a>
				    </div>
		        </div>
		        <div class="col col-sm-3 hidden-xs rtecenter padding-top-15">
					...
					<div class="social-icons">
						<ul>
							<li><a href="https://www.flickr.com/photos/brancelcharters/" target="_blank"><span class="social-circle"><i class="fa fa-flickr"></i></span></a></li>
							<li><a href="https://www.facebook.com/Brancel-Charters-159089050783151" target="_blank"><span class="social-circle"><i class="fa fa-facebook"></i></span></a></li>
							<li><a href="#" target="_blank"><span class="social-circle"><i class="fa fa-instagram"></i></span></a></li>
						</ul>
					</div>
		        </div>
		    </div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col col-sm-6 col-sm-pull-6 mobile-centered">
					© 2019 Brancel Bicycle Charters. &nbsp;All Rights Reserved.<br>
					608-215-5939 | P.O. Box 98 | Waunakee, WI 53597 | <a href="/contact-us">email us</a>
				</div>
			</div>
		</div>
	</div>
